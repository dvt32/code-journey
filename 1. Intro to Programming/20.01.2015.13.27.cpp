...
17. Зададени са два едномерни масива от символни низове 
А0, А1,...,Аn-1 и E0, E1,..., En-1, където Аi и Ei са 
съответно името и ЕГН на i-тото лице. Да се състави програма, която извежда името на най-младата жена.
...
void main(){
	...
	cout << "Най-младата жена се казва " << A_youngestWoman << "." << endl; return;
