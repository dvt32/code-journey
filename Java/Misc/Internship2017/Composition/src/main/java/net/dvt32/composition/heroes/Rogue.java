	...
	implements AssassinSkillset, SpellcasterSkillset
{
	 ...
	 * @param health The Rogue's health points
	 * @param damage The Rogue's damage points
	 * @param strength The Rogue's agility points (special power)
	 * @param weapon The Rogue's weapon type
	 */
	public Rogue(int health, int damage, int agility, Weapon weapon) {
		super(health, damage, agility, weapon);
	}
