...
- извежда общата стойност на лекарствата в аптеката с цена над 10 лв.;
- създава нов масив с данните на лекарствата с цена над 15 лв;
- създава нов масив с имената и цените на лекарствата с изтичащ срок на годност на зададена дата.
...
void main(){
	...
	double sum = 0;		// сума на цените над 10 лв.
	...
	do
	{
		...
		cout << " - [3]: Изведи общата стойност на лекарствата в аптеката с цена над 10 лв." << endl;
		cout << " - [4]: Създай масив с данните на лекарствата с цена над 15 лв." << endl;
		...
		case 2:
			...
			break;
		case 3:
			for (i = 0; i < br; ++i) { if (Group[i].price > 10) { sum += Group[i].price; } }
			cout << "\n---\n\n";
			cout << "Обща стойност на лекарствата в аптеката с цена над 10 лв: " << sum << " лв. " << endl << endl;
			cout << "---\n\n";
			break;
		 case 4:
		 ...
		 case 5:
			 ...
			 for (i = 0, j = 0; i < br; ++i){
					 ...
					 Group[i].expDate_year == expDateYear)
				 {
					 ...
					 Group[j].price = Group[i].price;
					 cout << "Наименование: " << Group[j].name << endl;
					 cout << "Цена: " << Group[j].price << " лв." << endl << endl;
					 br2++;
					 j++;
				 }
			 }
