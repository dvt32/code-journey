...
13. Зададен е едномерен масив от цели числа А0, А1,...,Аn-1, където n e кратно на 2. 
Да се състави програма, която изчислява 
разликата между 
- средно-аритметичното на нечетните елементи от първата половина 
- и средно-аритметичното на нечетните елементи от втората половина на масива.
...
void main() {
	...
	cout << "Средно-аритметично от 1 половина на нечетните елементи: " << avg_firstHalf << endl;
	cout << "Средно-аритметично от 2 половина на нечетните елементи: " << avg_secondHalf << endl << endl;
