...
public:
	...
	Kniga getData(); //Прототип на член-функцията getData
...
Kniga Kniga::getData(){
	...
	// Връщане на обект с данните съхранени в оригиналните променливи, 
	// чиито стойности ще бъдат присвоени на всеки елемент от MasKnigi
	return resultObject;
}
...
void main(){
	...
	do {
		...
		case '0':break;
		case '1':
			MasKnigi[BrKn] = MasKnigi[BrKn].getData();
			BrKn++;
			break;
