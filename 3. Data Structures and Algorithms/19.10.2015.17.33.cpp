...
Задача 4. Даден е списък от символни низове. Да се напише програма, която
...
int main() {
	...
	// Get each string's length and display end result
	std::cout << "Length of each string: ";
	element = list.first;
	while (element != NULL) {
		std::cout << element->inf.length() << " ";
